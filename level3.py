...
player_image = pygame.transform.scale(load_image('materials/images/img_2.png'), (40, 70))
...
class Comp_Menu(pygame.sprite.Sprite):
    image = load_image('materials/images/completed2.png')
    # вот следующие чсила меняют размер поздравления
    image = pygame.transform.scale(image, (680, 400))
...
#
#     text_t = font.render(f'fgvj', True, (255, 255, 255))
#     SCREEN.blit(text_t, (350, 10))
...
while running:
    ...
    if time_go:
        ...
        SCREEN.blit(text_t, (350, 10))
    if texting_show:
        # координата левого вернехго угла расположения поздравления
        menu_table = Comp_Menu(30, 20)
        menu_main = Comp_Main(550, 470)
